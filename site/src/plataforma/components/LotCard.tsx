  ...
  return (
    <div>
      <Card className="p-2.5 bg-[#F0F6F2] w-[300px]">
        <CardHeader>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 -mr-4">
              {/* STATUS */}
              <div
                className={`flex items-center p-1.5 gap-0.5 font-medium font-ibmPlex 
              ...
              {role === "admin" && subLotes && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-40">
                    <DropdownMenuItem onClick={alterarlote}>
                      Alterar status
                    </DropdownMenuItem>
            ...
            <>
              <div className="flex items-center gap-2 justify-start">
                <div className="flex justify-end items-center gap-7 w-full">
                  <button
                    onClick={() => setDadosVendidos((prev) => !prev)}
                    className={`w-6 h-6 p-0.5 relative -top-1 rounded-full
        ...
        {/* BOTÃO EXCLUIR LOTE (quando NÃO é sublote) */}
        {role === "admin" && !subLotes && (
          <div>
            <button
              onClick={(e) => {
